...
const BEEHIIV_URL = "https://embeds.beehiiv.com/signup"; // replace with your actual Beehiiv embed URL
...
export default function App() {
  ...
  return (
    <div style={styles.root}>
      ...
      <section
        ref={ref("pain")}
        style={{ ...styles.section, ...styles.painSection }}
        className={visible["pain"] ? "reveal" : "pre-reveal"}
      >
        <div style={styles.container}>
          <p style={styles.painLead}>
            Atlassian just cut 1,600 jobs to fund AI investment. They won't be the last.
          </p>
          <p style={styles.painBody}>
            The people who survive this shift aren't the most educated. They're the ones who build fastest.
            A side income stream isn't a backup plan anymore — it's the plan.
            The window is open right now. Most people are waiting for permission to walk through it.
          </p>
          <p style={styles.painClose}>
            This blueprint is for the ones who are done waiting.
          </p>
        </div>
      </section>
      ...
      <section
        ...
        className={visible["steps"] ? "reveal" : "pre-reveal"}
      >
        <div style={styles.container}>
      ...
      <section
        ref={ref("email")}
        style={{ ...styles.section, ...styles.emailSection }}
        className={visible["email"] ? "reveal" : "pre-reveal"}
      >
        <div style={{ ...styles.container, textAlign: "center" }}>
          <h2 style={styles.h2}>Get the free checklist first</h2>
          <p style={styles.sectionSub}>
            The First Step Checklist — the exact 5 things to do before you build anything.<br />
          ...
          {!submitted ? (
            ...
            <div style={styles.thankYou}>
              ...
              <p style={styles.thankYouText}>
                ...
                <a href={GUMROAD_URL} target="_blank" rel="noreferrer" style={styles.upsellLink}>
                  Ready for the full blueprint? Get it here →
                </a>
              </p>
            </div>
          )}
      ...
      <section
        ref={ref("pricing")}
        style={styles.section}
        className={visible["pricing"] ? "reveal" : "pre-reveal"}
      >
        <div style={styles.container}>
          ...
          <div style={styles.pricingGrid}>
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                style={{ ...styles.pricingCard, ...(t.featured ? styles.pricingFeatured : {}) }}
          ...
          <p style={styles.guarantee}>
            Instant download. Keep it forever. If you go through it and get nothing — you still learned something worth more than $17.
          </p>
        </div>
      </section>
      ...
      <section
        ref={ref("faq")}
        style={styles.section}
        className={visible["faq"] ? "reveal" : "pre-reveal"}
      >
        <div style={styles.container}>
      ...
      <section
        ref={ref("final")}
        style={{ ...styles.section, ...styles.finalSection }}
        className={visible["final"] ? "reveal" : "pre-reveal"}
      >
        <div style={{ ...styles.container, textAlign: "center" }}>
          <h2 style={{ ...styles.h2, fontSize: "clamp(2rem, 5vw, 3.5rem)" }}>
...
const styles = {
  ...
  heroNoise: {
    position: "absolute",
    inset: 0,
    backgroundImage: `radial-gradient(ellipse 80% 60% at 50% 0%, rgba(200,240,96,0.07) 0%, transparent 70%)`,
    pointerEvents: "none",
  },
  heroInner: {
    maxWidth: "820px",
  ...
  heroLine: {
    ...
    right: 0,
    height: "1px",
    background: "linear-gradient(90deg, transparent, rgba(200,240,96,0.3), transparent)",
  },
  btnPrimary: {
  ...
  emailSection: {
    ...
    borderTop: "1px solid rgba(200,240,96,0.12)",
    borderBottom: "1px solid rgba(200,240,96,0.12)",
  },
  emailForm: {
    display: "flex",
    gap: "0.75rem",
...
const css = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .step-card:hover {
    border-color: rgba(200,240,96,0.3) !important;
    background: rgba(200,240,96,0.05) !important;
  }

  .pricing-card:hover {
    border-color: rgba(200,240,96,0.5) !important;
    transform: translateY(-3px);
  }

  a[style*="btnPrimary"]:hover, button:hover {
  ...
  ::selection {
    background: rgba(200,240,96,0.3);
  }
