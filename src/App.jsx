...
const CHECKLIST_URL = "https://getfluxe.gumroad.com/l/FreeDistributionChecklist";
    ...
    <div style={s.root}>
      ...
      <nav style={s.nav}>
        ...
        <div style={s.navLinks}>
          <a onClick={() => scrollTo("free")} style={s.navLink}>Free Guide</a>
      ...
      <section style={s.hero}>
        ...
        <div style={s.heroContent}>
          ...
          <div className="fade-up" style={{ ...s.heroCtas, animationDelay: "300ms" }}>
            <button onClick={() => scrollTo("free")} style={s.btnFree}>
        ...
        <div style={s.heroScroll} className="fade-up" onClick={() => scrollTo("free")}>
      ...
      <section ref={ref("free")} style={s.freeSection} className={visible["free"] ? "reveal" : "pre-reveal"}>
        <div style={s.freeInner}>
          <div style={s.freeContent}>
            <div style={s.freeBadge}>
              <span style={s.freeBadgeDot} />
              <span style={s.freeBadgeText}>FREE GUIDE</span>
            </div>
            <h2 style={s.freeTitle}>The Distribution Checklist</h2>
            <p style={s.freeDesc}>
              10 things small streamers should be doing off-stream to actually grow.
              No fluff. No fancy tools. Just the stuff that separates the ones who
              make it from the ones who blame the algorithm.
            </p>
            <div style={s.freeChecks}>
              <span style={s.freeCheck}>✓ Clip strategy that turns VODs into growth</span>
              <span style={s.freeCheck}>✓ How to connect Shorts to your live stream</span>
              <span style={s.freeCheck}>✓ The retention metric most streamers ignore</span>
              <span style={s.freeCheck}>✓ Off-stream networking that actually works</span>
              <span style={s.freeCheckFade}>+ 6 more inside</span>
            </div>
            <a href={CHECKLIST_URL} target="_blank" rel="noreferrer" style={s.freeBtn}>
              Download Free Checklist →
            </a>
            <span style={s.freeSubnote}>Free · Instant download · Just takes an email</span>
          </div>
          <div style={s.freeVisual}>
            <div style={s.freeCard}>
              <div style={s.freeCardItem}>
                <span style={s.freeCardCheck}>✓</span>
                <span style={s.freeCardText}>Clip best moments within 24hrs</span>
              </div>
              <div style={s.freeCardItem}>
                <span style={s.freeCardCheck}>✓</span>
                <span style={s.freeCardText}>Unique title & thumbnail per stream</span>
              </div>
              <div style={s.freeCardItem}>
                <span style={s.freeCardCheck}>✓</span>
                <span style={s.freeCardText}>30 min/day in other communities</span>
              </div>
              <div style={s.freeCardDivider} />
              <div style={s.freeCardItem}>
                <span style={s.freeCardBox} />
                <span style={s.freeCardTextDim}>Connect shorts to stream schedule</span>
              </div>
              <div style={s.freeCardItem}>
                <span style={s.freeCardBox} />
                <span style={s.freeCardTextDim}>Track who comes back, not count</span>
              </div>
              <div style={s.freeCardItem}>
                <span style={s.freeCardBox} />
                <span style={s.freeCardTextDim}>Talk TO chat, not AT camera</span>
              </div>
              <div style={s.freeCardDivider} />
              <div style={s.freeCardItem}>
                <span style={s.freeCardBox} />
                <span style={{ ...s.freeCardTextDim, opacity: 0.4 }}>+ 4 more inside</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section ref={ref("proof")} style={s.proofBar} className={visible["proof"] ? "reveal" : "pre-reveal"}>
        <div style={s.proofInner}>
          <div style={s.proofStat}>
            <span style={s.proofNum}>91K+</span>
            <span style={s.proofLabel}>Reddit views in 48hrs</span>
          </div>
          <div style={s.proofDivider} />
          <div style={s.proofStat}>
            <span style={s.proofNum}>235+</span>
            <span style={s.proofLabel}>Upvotes on first post</span>
          </div>
          <div style={s.proofDivider} />
          <div style={s.proofStat}>
            <span style={s.proofNum}>93%</span>
            <span style={s.proofLabel}>Upvote ratio</span>
          </div>
        </div>
      </section>
      ...
      <section ref={ref("newsletter")} style={{ ...s.section, ...s.newsletterSection }} className={visible["newsletter"] ? "reveal" : "pre-reveal"}>
        <div style={{ ...s.container, textAlign: "center" }}>
          <h2 style={s.h2}>Stay in the loop</h2>
          <p style={s.subtext}>Weekly insights on building income streams, AI tools, and the creator economy.</p>
          <iframe
        ...
        <div style={s.container}>
          ...
          <div style={s.faqList}>
            {[
              ...
              { q: "What's the free checklist?", a: "The Distribution Checklist covers 10 things small streamers should be doing off-stream to grow. It's free — just takes an email. Think of it as the starter before the full system." },
            ].map((f, i) => (
      ...
      <section ref={ref("final")} style={{ ...s.section, ...s.finalSection }} className={visible["final"] ? "reveal" : "pre-reveal"}>
        <div style={{ ...s.container, textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap", marginTop: "2.5rem" }}>
            <a href={CHECKLIST_URL} target="_blank" rel="noreferrer" style={s.btnFree}>
              Free Checklist →
            </a>
            <a href={ISTREAMCODE_URL} target="_blank" rel="noreferrer" style={{ ...s.btnPrimary, background: "#5a90ff" }}>
              iStreamCode →
...
const s = {
  ...
  btnFree: { display: "inline-block", background: "#e94560", color: "#ffffff", padding: "0.85rem 2rem", borderRadius: "3px", fontWeight: 700, fontSize: "0.9rem", textDecoration: "none", letterSpacing: "0.01em", border: "none", cursor: "pointer", fontFamily: "'Outfit', sans-serif", transition: "transform 0.15s, box-shadow 0.15s" },
  ...
  freeSection: { padding: "5rem 2rem", background: "linear-gradient(180deg, rgba(233,69,96,0.06) 0%, rgba(8,8,10,1) 100%)", borderTop: "1px solid rgba(233,69,96,0.15)", borderBottom: "1px solid rgba(233,69,96,0.08)", transition: "opacity 0.7s ease, transform 0.7s ease" },
  freeInner: { maxWidth: "1000px", margin: "0 auto", display: "flex", gap: "3rem", alignItems: "center", flexWrap: "wrap" },
  freeContent: { flex: "1 1 400px", display: "flex", flexDirection: "column", gap: "1rem" },
  freeBadge: { display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(233,69,96,0.12)", border: "1px solid rgba(233,69,96,0.3)", borderRadius: "100px", padding: "6px 16px", width: "fit-content" },
  freeBadgeDot: { width: "8px", height: "8px", background: "#e94560", borderRadius: "50%", display: "inline-block" },
  freeBadgeText: { fontSize: "0.7rem", fontWeight: 700, color: "#e94560", letterSpacing: "2px" },
  freeTitle: { fontFamily: "'Syne', sans-serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 800, color: "#e8e4dc", lineHeight: 1.1 },
  freeDesc: { fontSize: "0.95rem", color: "rgba(232,228,220,0.5)", lineHeight: 1.7, maxWidth: "460px" },
  freeChecks: { display: "flex", flexDirection: "column", gap: "6px", marginTop: "0.5rem" },
  freeCheck: { fontSize: "0.85rem", color: "rgba(232,228,220,0.65)", lineHeight: 1.5 },
  freeCheckFade: { fontSize: "0.85rem", color: "rgba(232,228,220,0.3)", lineHeight: 1.5 },
  freeBtn: { display: "inline-block", width: "fit-content", background: "#e94560", color: "#ffffff", padding: "0.9rem 2.2rem", borderRadius: "3px", fontWeight: 700, fontSize: "0.95rem", textDecoration: "none", letterSpacing: "0.01em", transition: "transform 0.15s, box-shadow 0.15s", marginTop: "0.5rem" },
  freeSubnote: { fontSize: "0.75rem", color: "rgba(232,228,220,0.3)", letterSpacing: "0.03em" },

  // Free checklist visual card
  freeVisual: { flex: "0 1 320px", display: "flex", justifyContent: "center" },
  freeCard: { width: "300px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "12px", padding: "24px 22px", backdropFilter: "blur(10px)", transform: "rotate(1.5deg)", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" },
  freeCardItem: { display: "flex", alignItems: "flex-start", gap: "12px", marginBottom: "12px" },
  freeCardCheck: { width: "20px", height: "20px", minWidth: "20px", background: "#e94560", borderRadius: "5px", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: "12px", fontWeight: 700, lineHeight: "20px", textAlign: "center" },
  freeCardBox: { width: "20px", height: "20px", minWidth: "20px", border: "2px solid rgba(255,255,255,0.15)", borderRadius: "5px" },
  freeCardText: { fontSize: "0.82rem", color: "rgba(255,255,255,0.8)", lineHeight: 1.4 },
  freeCardTextDim: { fontSize: "0.82rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.4 },
  freeCardDivider: { height: "1px", background: "rgba(255,255,255,0.06)", margin: "10px 0" },
